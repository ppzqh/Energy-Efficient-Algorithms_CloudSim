 ...
 *
 */
package org.cloudbus.cloudsim.power.random;
...
public class RandomHelper {
	 ...
	 */
	public static List<Cloudlet> createCloudletList(int brokerId, int cloudletsNumber, int index) {
		List<Cloudlet> list = new ArrayList<Cloudlet>();

		long fileSize = 300;
		long outputSize = 300;
		long seed = RandomConstants.CLOUDLET_UTILIZATION_SEED + index;
