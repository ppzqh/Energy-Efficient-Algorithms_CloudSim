...
public class Constants {
	...
	public final static int GLOBAL_BROKER_INTERVAL = 1000;
	/*
	 * VM instance types:
	...
	public final static int[] VM_MIPS	= { 2500, 2000, 1000, 500 };//{250, 500, 750, 1000};
	public final static int[] VM_PES	= { 1, 1, 1, 1 };
	public final static int[] VM_RAM	= { 870,  1740, 1740, 613 };//{128,128,128,128};
	public final static int VM_BW		= 100000; //调整为很小
	...
	public final static int[] HOST_MIPS	 = {1860, 2660};//{2000, 2660};
	public final static int[] HOST_PES	 = {2, 2};
	public final static int[] HOST_RAM	 = {4096, 4096 };//{8192, 8192, 8192};//{ 4096, 4096 };
	public final static int HOST_BW		 = 1000000; // 1 Gbit/s
	public final static int HOST_STORAGE = 1000000;//1T //1000000; // 1 GB
