...
//					vmAllocationPolicy);
			PowerDatacenter datacenter = (PowerDatacenter) Helper.createDatacenter(
					"Datacenter",
					PowerDatacenterLearningAutomata.class,
					hostList,
					vmAllocationPolicy);
	...
	protected VmAllocationPolicy getVmAllocationPolicy(
		...
		else if (vmAllocationPolicyName.equals("BFD")){
		...
		else if (vmAllocationPolicyName.equals("GRANITE")){
		...
		else if (vmAllocationPolicyName.equals("LearningAutomata")){
