...
//			vm[i] = new Vm(idShift + i, userId, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			vm[i] = new PowerVm(idShift + i, userId, mips, pesNumber, ram, bw, size, 1, vmm,
					new CloudletSchedulerDynamicWorkload(mips, pesNumber), Constants.SCHEDULING_INTERVAL);
			list.add(vm[i]);
		}
	...
	public static void main(String[] args) {
		...
		try {
			...
			GlobalBroker globalBroker = new GlobalBroker("GlobalBroker",10);
			GlobalBroker globalBroker1 = new GlobalBroker("GlobalBroker", 20);
...
//			Datacenter datacenter1 = createDatacenter("Datacenter_1");
	...
	public static class GlobalBroker extends SimEntity {
		...
		public GlobalBroker(String name, int delay1) {
			super(name);
			this.delay = delay1;
		}
