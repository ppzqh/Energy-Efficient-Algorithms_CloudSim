...
import org.cloudbus.cloudsim.power.models.SimplePowerModel;
...
//	public final static int CLOUDLET_LENGTH	= (int) SIMULATION_LIMIT;
	...
	public final static int VM_BW		= 1; //调整为很小
	public final static int VM_SIZE		= 1000;//2500; // 2.5 GB
