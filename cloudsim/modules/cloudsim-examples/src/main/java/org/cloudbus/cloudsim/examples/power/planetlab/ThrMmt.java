...
public class ThrMmt {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFolder = "/Users/pp/Downloads/cloud_computing/cloudsim/modules/cloudsim-examples/src/main/resources/workload/planetlab/";//NonPowerAware.class.getClassLoader().getResource("workload/planetlab").getPath();
		String outputFolder = "output";
		String workload = "20110403"; // PlanetLab workload
		String vmAllocationPolicy = "thr";//"Probabilistic";//"thr"; // Static Threshold (THR) VM allocation policy
